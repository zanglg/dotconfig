...
function mappings.init()
    ...
    map("n", "<leader>s", "<cmd>Telescope grep_string<cr>",                   {expr = false, noremap = true})
    map("n", "<leader>S", "<cmd>Telescope lsp_dynamic_workspace_symbols<cr>", {expr = false, noremap = true})
    map("n", "<leader>l", "<cmd>Telescope lsp_document_symbols<cr>",          {expr = false, noremap = true})
