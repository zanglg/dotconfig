...
call s:HL("TSConditional",                      s:pink,          '',              '')
...
call s:HL("TSOperator",                         s:cyan,          '',              '')
call s:HL("TSParameter",                        s:brown,         '',              '')
call s:HL("TSParameterReference",               s:cyan,          '',              '')
call s:HL("TSProperty",                         s:purple,        '',              '')
call s:HL("TSPunctDelimiter",                   s:cyan,          '',              '')
call s:HL("TSPunctBracket",                     s:cyan,          '',              '')
call s:HL("TSPunctSpecial",                     s:cyan,          '',              '')
call s:HL("TSRepeat",                           s:pink,          '',              '')
call s:HL("TSString",                           s:green,         '',              '')
call s:HL("TSStringRegex",                      s:green,         '',              '')
call s:HL("TSStringEscape",                     s:green,         '',              '')
call s:HL("TSTag",                              s:red,           '',              '')
call s:HL("TSTagDelimiter",                     s:cyan,          '',              '')
...
call s:HL("LspDiagnosticsDefaultHint",          s:inconspicuous, '',              '')
call s:HL("LspDiagnosticsDefaultError",         s:inconspicuous, '',              '')
call s:HL("LspDiagnosticsDefaultWarning",       s:inconspicuous, '',              '')
call s:HL("LspDiagnosticsDefaultInformation",   s:inconspicuous, '',              '')
call s:HL("LspDiagnosticsUnderlineError",       s:red,           '',              '')
call s:HL("LspDiagnosticsUnderlineWarning",     s:yellow,        '',              '')
call s:HL("LspDiagnosticsUnderlineInformation", s:green,         '',              '')
call s:HL("LspDiagnosticsUnderlineHint",        s:inconspicuous, '',              '')
...
let g:rainbow_conf = { 'guifgs' : [ s:red, s:cyan, s:violet, s:yellow, s:blue, s:green, s:purple ] }
...
if has('nvim')
    ...
    let g:terminal_color_15         = s:cyan
